...
////    @BeforeEach
////    void setup() {
////        game = GameState.getInstance().createGame();
////    }
//
//    @Test
...
//        assertTrue(game.getInventory().isEmpty(), "The item should not have been added to the inventory.");
//    }
//
//    @Test
...
//        Game game = GameState.getInstance().getGame();
//        game.setCurrentLocation(new Location("", "", new ArrayList<>(), new ArrayList<>(), true, "treeless location"));
...
//        Game game = GameState.getInstance().getGame();
//        game.setCurrentLocation(new Location("", "", new ArrayList<>(), new ArrayList<>(), true, "driveway"));
//        final String result = getItem("tree");
