...
public class ResponseConstants {
    ...
    public static final String INFO_RESPONSE = "If you want to end your adventure early say \"quit\" or \"restart\". " +
            ...
            "though you get some points for finding it. You lose points for getting killed, or for quitting, though the former costs you more. " +
            "You also gain points for solving problems and getting to places that are difficult to get to. " +
            "The more you explore, the more points you will likely get.";

    public static final String HELP_RESPONSE = "You can move around with directions like \"north\", \"south\", \"northwest\", \"southwest\", etc., \"up\", or \"down\", " +
            "which can also be shortened \"n\", \"s\", \"e\", \"w\", \"nw\", \"ne\", \"sw\", etc., \"u\", \"d\". " +
