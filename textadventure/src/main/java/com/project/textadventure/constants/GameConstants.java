...
public class GameConstants {
    ...
    public static final String DEATH_BY_MINE_SHAFT = "<p>OK. I warned you. You walk up to the wooden supports and start to remove the loose nails and, " +
            ...
            "mountain and old wood is very dangerous, thus this decision has cost you your life.</p>";
