...
public class LocationDescriptions {
    ...
    public static final String ANT_HILL_LONG_DESCRIPTION = "Nearby is an ant hill with little black ants scurrying about doing their business. The ditch goes west from here.";
    ...
    public static final String BOTTOM_MINE_SHAFT_WITH_CAGE_LONG_DESCRIPTION = "You are at the bottom of a vertical mine shaft with a working mine cage to the east. Next to the mine cage is a button labeled \"Up/Down\". A mine railway starts here and runs west.";
    ...
    public static final String DRIVEWAY_LONG_DESCRIPTION = "You are at the west end of a dirt road surrounded by a forest of pine trees. There is a small gap to the north that exposes a steep, dirt driveway sloping down into the forest. It looks like there are some man-made objects down the driveway, but it's hard to tell what. Looking down the road to the east you can see over the trees and into the valley. There's also a foot path going northwest.";
    ...
    public static final String EAST_END_SIDE_STREET_LONG_DESCRIPTION = "You are at the east end of a side street in an abandoned gold mining town. A much wider road, capable of supporting heavy traffic, goes north and south from here, exiting the town in both directions.";
    public static final String FIELDS_OF_GRASS_LONG_DESCRIPTION = "Fields of grass surround you. The road goes south into the valley and to the north it winds up the mountain.";
    ...
    public static final String MOUNTAIN_PASS_WITH_CAGE_LONG_DESCRIPTION = "You're at a mountain pass. This vantage point gives a magnificent view of the valley. The road goes down the mountain to the south and there's a working mine cage to the west with a button labeled \"Up/Down\" to the side.";
    public static final String MOUNTAIN_PASS_NO_CAGE_LONG_DESCRIPTION = "You're at a mountain pass. This vantage point gives a magnificent view of the valley. The road goes down the mountain to the south and a vertical mine shaft to the west with a button labeled \"Up/Down\" to the side.";
    ...
    public static final String PRIVATE_PROPERTY_LONG_DESCRIPTION = "All around you is a dense pine forest that gives the air a friendly smell. A driveway continues into the forest to the north and closer to a road to the south, and, to the northeast, a tidy trail leads into the forest as well.";
    ...
    public static final String SHED_LONG_DESCRIPTION = "Here is a cheerful shed with wood painted a tan color. Its doors are firmly shut and locked. There's a sturdy picnic table to the south.";
