...
public class LocationDescriptions {
    ...
    public static final String DITCH_LONG_DESCRIPTION = "You are in the middle of the forest standing in a small ditch running east and west. A path goes up the hill to the south.";
